...
final changeFavouriteMealStatusUseCaseImpl = Provider.autoDispose<ChangeFavouriteMealStatusUseCaseImpl>(
    (ref) => ChangeFavouriteMealStatusUseCaseImpl(ref.read(postLocalDataSourceImpl)));

class ChangeFavouriteMealStatusUseCaseImpl extends ChangeFavouriteMealStatusUseCase {
