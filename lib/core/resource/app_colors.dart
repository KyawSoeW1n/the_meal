...
abstract class AppColors {
  static const Color primaryColor = Color(0xFFE36D0B);
  static const Color secondaryColor = Color(0xFF5777F9);
  static const Color pageBackground = Color(0xFFFFFFFF);
  static const Color black = Color(0xFF222232);
  static const Color lightBlueColor2 = Color(0xffe8ecff);
  static const Color white = Color(0xffffffff);
  static const Color tabBackgroundColor = Color(0xff8c8c8c);
  static const Color textColorSecondary = Color(0xFF9FA4B0);
  static const Color textColorGrey = Color(0xFF65656B);
